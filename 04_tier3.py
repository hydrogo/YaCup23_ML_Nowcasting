...
parser.add_argument("--leadtime", type=int, choices=[1, 12], 
                    help="prediction lead time")
...
# Set-up Callbacks
checkpoint_filepath = f'./models/{MODEL}_{BACKBONE}_{LEADTIME}_{TRAINSET}_tier3_repr.keras'
...
print(f"Tier 3: lead time: {LEADTIME}, trainset: {TRAINSET}.")
